...
Uruchamia testy dla:
1. DES: ../data_weak_ciphers/des/compressed_des_12346.bin (instancja fast_nist_sts_instance5)
2. CAST: ../data_weak_ciphers/cast/compressed_cast_12346.bin (instancja fast_nist_sts_instance6)
3. Blowfish: ../data_weak_ciphers/blowfish/compressed_blowfish_12346.bin (instancja fast_nist_sts_instance7)
4. RC4: ../data_weak_ciphers/rc4/compressed_rc4_12346.bin (instancja fast_nist_sts_instance8)
...
FAST_NIST_INSTANCES = {
    "compressed_des_12346.bin": {
        "base_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance1"),
        "experiments_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance1/experiments/AlgorithmTesting"),
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/des/compressed_des_12346"),
    },
    "compressed_cast_12346.bin": {  
        "base_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance2"),
        "experiments_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance2/experiments/AlgorithmTesting"),
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/cast/compressed_cast_12346"),
    },
    "compressed_rc4_12346.bin": {
        "base_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance3"),
        "experiments_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance3/experiments/AlgorithmTesting"),
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/rc4/compressed_rc4_12346"),
    },
    "compressed_blowfish_12346.bin": {
        "base_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance4"),
        "experiments_dir": Path("/home/paugustynowicz/cipher_recognition/fast_nist_sts_instance4/experiments/AlgorithmTesting"),
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/blowfish/compressed_blowfish_12346"),
    },
}
...
def main() -> int:
    ...
    print(f"\n{'='*100}", file=sys.stderr)
    print("URUCHAMIANIE RÓWNOLEGŁYCH TESTÓW NIST STS (INSTANCJE 1-4)", file=sys.stderr)
    ...
    tests = [
        ("compressed_des_12346.bin", Path("../data_weak_ciphers/des")),
        ("compressed_cast_12346.bin", Path("../data_weak_ciphers/cast")),
        ("compressed_blowfish_12346.bin", Path("../data_weak_ciphers/blowfish")),
        ("compressed_rc4_12346.bin", Path("../data_weak_ciphers/rc4")),
    ]
    ...
    # Zwróć kod wyjścia (1 = sukces, 0 = błąd – spójne z implementacją NIST assess)
