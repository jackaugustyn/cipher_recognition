...
Uruchamia testy dla:
1. DES: ../data_weak_ciphers/des/des_12355.bin (instancja fast_nist_sts_instance1)
2. CAST: ../data_weak_ciphers/cast/cast_12355.bin (instancja fast_nist_sts_instance2)
3. Blowfish: ../data_weak_ciphers/blowfish/blowfish_12355.bin (instancja fast_nist_sts_instance3)
4. RC4: ../data_weak_ciphers/rc4/rc4_12355.bin (instancja fast_nist_sts_instance4)
...
# Konfiguracja dla różnych instancji fast_nist_sts
FAST_NIST_INSTANCES = {
    "des_12355.bin": {
        ...
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/des/des_12355"),
    },
    "cast_12355.bin": {
        ...
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/cast/cast_12355"),
    },
    "rc4_12355.bin": {
        ...
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/rc4/rc4_12355"),
    },
    "blowfish_12355.bin": {
        ...
        "log_dir": Path("/home/paugustynowicz/cipher_recognition/logs/blowfish/blowfish_12355"),
    },
}
...
def main() -> int:
    ...
    Każdy test używa innej instancji oprogramowania fast_nist_sts.
    """

    print(f"\n{'='*100}", file=sys.stderr)
    print("URUCHAMIANIE RÓWNOLEGŁYCH TESTÓW NIST STS", file=sys.stderr)
    ...
    tests = [
        ("des_12355.bin", Path("../data_weak_ciphers/des")),
        ("cast_12355.bin", Path("../data_weak_ciphers/cast")),
        ("blowfish_12355.bin", Path("../data_weak_ciphers/blowfish")),
        ("rc4_12355.bin", Path("../data_weak_ciphers/rc4")),
    ]
    ...
    # Podsumowanie
    print(f"\n{'='*100}", file=sys.stderr)
    print("PODSUMOWANIE RÓWNOLEGŁYCH TESTÓW", file=sys.stderr)
    print(f"{'='*100}", file=sys.stderr)
